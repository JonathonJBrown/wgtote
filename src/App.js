  ...
  return (
    <div style={{minHeight:"100vh",display:"flex",alignItems:"center",justifyContent:"center",background:"#0C0E13",fontFamily:"'DM Sans',sans-serif"}}>
      <div style={{textAlign:"center",maxWidth:400,padding:24}}>
        ...
        <button onClick={()=>pick("3col")} style={{width:"100%",padding:"16px 20px",borderRadius:8,border:"2px solid #2A2F3D",background:"#14171E",color:"#E8EAF0",cursor:"pointer",marginBottom:16,textAlign:"left",fontFamily:"'DM Sans',sans-serif"}}>
          <div style={{fontSize:15,fontWeight:700,marginBottom:4}}>3 Column</div>
          <div style={{fontSize:10,color:"#9BA3B5",lineHeight:1.4}}>Vocabulary, Excellence, and Ranking panel all side by side with notes below. Best for full-screen iPad or desktop.</div>
        </button>
